...
INJECTION_WARNING = """
                    SQL agent can be vunlnerable to prompt injection. Use DB role with limited.
...
def configure_db(db_uri=None, mysql_host=None, mysql_user=None, mysql_password=None, mysql_db=None):
    if db_uri == LOCALDB:
...
if "messages" not in st.session_state or st.sidebar.button("Clear message history"):
    st.session_state["messages"] = [{"role": "assiatnt", "content": "How can I help you?"}]
